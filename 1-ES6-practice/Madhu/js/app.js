...
function displayPics(){
  ...
  // Because when we use 'let', variable 'rando' is limited only the scope of the while loop(block of code). Console doesn't have access to the variable that was declared with 'let' inside while loop
  console.log(viewed);
