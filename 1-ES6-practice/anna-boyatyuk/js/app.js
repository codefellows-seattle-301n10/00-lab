...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: The previous line of code threw an error because variables defined with const are scoped to a code block and can't be used outside of that code block.
  console.log(viewed);
