...
function displayPics(){
  ...
  // The rando variable was locally scoped to the while conditional in displayPics function. Due to the console log being outside of the while conditional where variable rando is located it is unable to see or do anything with it.
  console.log(viewed);
