...
function displayPics(){
  ...
  // 'let' declares variables that are limited to that scope.  In this case, it was declared in the while loop and therefore the scope is in that while loop.  The console log statement is outside of that scope and therefore 'rando' is not declared because it is outside of that scope.
  console.log(viewed)
