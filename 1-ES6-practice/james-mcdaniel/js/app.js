...
function displayPics(){
  ...
  // The variable rando is declared within the displayPics() function, so its scope is limited to within that function.  As far as the browser is concerned, the variable only exists between lines 29 and 36.
  console.log(viewed)
