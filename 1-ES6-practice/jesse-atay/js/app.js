...
function displayPics(){
  ...
  // The previous line of code threw an error, because rando is a block scoped variable, localized within the function to hold values for the makeRandom() function call. "let" contains it as a block within the particular expression, so when we try to console.log outside of the while loop the value cannot be accessed.
  console.log(viewed);
