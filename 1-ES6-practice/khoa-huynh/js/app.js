...
function displayPics(){
  ...
  // The reason that the previous line threw an error when we changed var to let is because when let is used inside the conditional, the scope of the let is local, rather than global.
  console.log(viewed);
