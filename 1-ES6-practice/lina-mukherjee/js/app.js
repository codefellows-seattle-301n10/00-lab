...
function displayPics(){
  ...
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `let to `const`.
  // console.log(rando) was referencing rando outside the block scope where it was defined.
  console.log(viewed);
