...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: The scope of const is contained in the local constiable whithin the block of code it is in.  The console.log(rando) is outside the scope of "const rando"
  console.log(viewed);
