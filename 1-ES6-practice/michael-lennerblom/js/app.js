...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: The scope of let is contained in the local letiable whithin the block of code it is in.  The console.log(rando) is outside the scope of "let rando"
  console.log(viewed);
