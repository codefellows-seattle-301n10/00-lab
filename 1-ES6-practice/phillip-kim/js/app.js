...
function displayPics(){
  ...
  // 'const' declares variables within the blocked scope.  However, if the variable is delcared outside of the blocked scope, javascript will not recognize the value.  Since the console.log is outside of the while variable, rando is not defined and causes an error.
  console.log(viewed);
