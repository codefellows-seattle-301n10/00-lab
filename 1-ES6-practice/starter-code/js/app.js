...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT:  rando was only available to that block of code inside the displayPics function. console log did not have access to it. i changed it back to var to make it available.
  console.log(viewed);
